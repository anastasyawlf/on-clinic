<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
  ...
  <div class="navbar-header">
    ...
    <a href="dashboard.php" class="navbar-brand">
      ...
      <span class="brand-name">On-Clinic</span>
    </a>
  </div><!-- .navbar-header -->
      ...
      <ul class="nav navbar-toolbar navbar-toolbar-right navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu animated flipInY">
            <li><a href="../doctor/profile.php"><i class="zmdi m-r-md zmdi-hc-lg zmdi-account-box"></i>Profil Saya</a></li>
            <li><a href="../doctor/change-password.php"><i class="zmdi m-r-md zmdi-hc-lg zmdi-balance-wallet"></i>Ubah Kata Sandi</a></li>
            <li><a href="../doctor/logout.php"><i class="zmdi m-r-md zmdi-hc-lg zmdi-sign-in"></i>Logout</a></li>
