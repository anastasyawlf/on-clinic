...
if (strlen($_SESSION['damsid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "update tblemployee set Name=:name,MobileNumber=:mobilenumber,email=:email where ID=:did";
            ...
            <div class="col-md-12">
              <div class="widget">
                <header class="widget-header">
                  <h3 class="widget-title">Profil Admin</h3>
                    ...
                    foreach ($results as $row) {               ?>
                      <form class="form-horizontal" method="post">
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input id="fname" type="text" class="form-control" placeholder="Full Name" name="fname" required="true" value="<?php echo $row->Name; ?>">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="email2" name="mobilenumber" value="<?php echo $row->MobileNumber; ?>" required='true' maxlength='20'>
                          </div>
                        </div>
                        <!-- <div class="form-group">
                          <label for="email2" class="col-sm-3 control-label">Poli:</label>
                          <div class="col-sm-9">
                        ...
                        <!-- <div class="form-group">
                          <label for="email2" class="col-sm-3 control-label">Tanggal Registrasi:</label>
                          <div class="col-sm-9">
