...
?>
  ...
  <head>
    ...
    <title>On-Clinic - Laporan Reservasi Antara Tanggal</title>
            ...
            <div class="col-md-12">
              <div class="widget">
                <header class="widget-header">
                  <h3 class="widget-title">Laporan Reservasi Antara Tanggal</h3>
                ...
                <div class="widget-body">
                  ...
                  <form class="form-horizontal" method="post" name="bwdatesreport" action="appointment-bwdates-reports-details.php">
                    <div class="form-group">
                      <label for="exampleTextInput1" class="col-sm-3 control-label">Dari Tanggal:</label>
                      <div class="col-sm-9">
                        <input type="date" class="form-control" id="fromdate" name="fromdate" value="" required='true'>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="email2" class="col-sm-3 control-label">Hingga Tanggal:</label>
                      <div class="col-sm-9">
