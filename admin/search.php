...
?>
	...
	<head>
		...
		<title>On-Clinic || Cari Detail Reservasi</title>
								...
								<header class="widget-header">
									<form id="basic-form" method="post">
										<div class="form-group">
											<label>Cari Berdasarkan Nomor Reservasi/Nama/Nomor Telepon</label>
											<input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Nomor Reservasi/Nama/Nomor Telepon">
										</div>
								...
								?>
									...
									<div class="widget-body">
										<div class="table-responsive">
											...
											<tr>
												<td colspan="8"> Hasil Pencarian Tidak Ditemukan</td>
