...
if (strlen($_SESSION['damsid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT ID FROM tbl WHERE ID=:eid and Password=:cpassword";
    ...
    if ($query->rowCount() > 0) {
      $con = "update tbl set password=:newpassword where ID=:eid";
...
?>
  ...
  <head>
    ...
    <title>On-Clinic - Ubah Kata Sandi</title>
            ...
            <div class="col-md-12">
              <div class="widget">
                <header class="widget-header">
                  <h3 class="widget-title">Perbarui Kata Sandi</h3>
                ...
                <div class="widget-body">
                  ...
                  <form class="form-horizontal" onsubmit="return checkpass();" name="changepassword" method="post">
                    <div class="form-group">
                      <label for="exampleTextInput1" class="col-sm-3 control-label">Kata Sandi Sekarang:</label>
                      <div class="col-sm-9">
                        <input type="password" class="form-control" name="currentpassword" id="currentpassword" required='true'>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="email2" class="col-sm-3 control-label">Kata Sandi Baru:</label>
                      <div class="col-sm-9">
                        <input type="password" class="form-control" name="newpassword" class="form-control" required="true">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="email2" class="col-sm-3 control-label">Konfirmasi Kata Sandi Baru:</label>
                      <div class="col-sm-9">
