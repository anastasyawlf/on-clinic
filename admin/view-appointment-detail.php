...
if (strlen($_SESSION['damsid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query->execute();
    echo '<script>alert("Remark dan Status telah diperbarui")</script>';
...
?>
  ...
  <head>
    ...
    <title>On-Clinic || Detail Reservasi</title>
            ...
            <div class="col-md-12">
              <div class="widget">
                <header class="widget-header">
                  <h4 class="widget-title" style="color: blue">Detail Reservasi</h4>
                          ...
                          <tr>
                            ...
                            <td colspan="4"> <?php $status = $row->Status;
                                              ...
                                              if ($row->Status == "Approved") {
                                                echo "Reservasi Anda Telah Diperbarui";
                                              }


                                              if ($row->Status == "Cancelled") {
                                                echo "Reservasi Anda Dibatalkan";
                                              }; ?></td>
                          </tr>
                          <tr>
                            ...
                            <?php if ($row->Remark == "") { ?>
                              ...
                              <td colspan="3"><?php echo "Belum Diperbarui"; ?></td>
                      ...
                      <?php $cnt = $cnt + 1;
                        ...
                        ?>
                          <p align="center" style="padding-top: 20px">
                            <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Ambil Tindakan</button>
                          </p>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Ambil Tindakan</h5>
